...
export DATABASE_URL="postgresql://neondb_owner:<LEAKED-NEON-PW-PRIOR-1>@ep-fancy-snow-ah3jjx69-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
