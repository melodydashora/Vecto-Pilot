...
```
DATABASE_URL_UNPOOLED=postgresql://neondb_owner:<LEAKED-NEON-PW-CURRENT>@ep-rough-bonus-afrj8m3u.c-2.us-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require
```
