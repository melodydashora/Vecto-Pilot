...
### [TODO] Auto-activate microphone on Coach screen open [RESOLVED BY PR #31]
...
### [BUG] Voice input stuck in continuous listening mode [RESOLVED BY PR #31]
...
### [FEATURE_REQUEST] Hands-free voice loop: Keyword submit and Auto-listen [RESOLVED BY PR #31]
...
### [FEATURE_REQUEST] Voice interruption and auto-listen command [RESOLVED BY PR #31]
...
### [BUG] TTS Audio Lifecycle & Tab Navigation [RESOLVED BY PR #31]
...
### [BUG] Speech Recognition & TTS State Clash [RESOLVED BY PR #31]
...
### [BUG] Stop button does not interrupt TTS audio playback [RESOLVED BY PR #31]
...
### [FEATURE_REQUEST] Verbal stop/submit commands for STT [RESOLVED BY PR #31]
...
### [BUG] Stop button kills audio but automatically re-opens microphone [RESOLVED BY PR #31]
