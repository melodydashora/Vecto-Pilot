...
| **Operational Queue** | Current work only. Items resolved here, not stored. | DOC_DISCREPANCIES.md, `claude_memory` active rows (`pending.md` retired 2026-04-29; see CLAUDE.md Rule 15) |
