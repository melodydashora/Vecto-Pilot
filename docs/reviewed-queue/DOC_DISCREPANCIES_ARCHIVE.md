# Documentation Discrepancies — Archive

> **This is the archive.** For the active queue of open items, see [`docs/DOC_DISCREPANCIES.md`](../DOC_DISCREPANCIES.md).
>
> Archived on 2026-04-14 (Issue AG). Contains all resolved items and historical sections for reference.

**Original Status:** BLOCKING QUEUE
