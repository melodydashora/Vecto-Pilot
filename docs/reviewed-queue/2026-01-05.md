...
**Generated:** 2026-01-05T22:12:39.548Z
**Branch:** main
**Last Commit:** 227f2a3 Fix JWT_SECRET fallback inconsistency and document audit findings
...
| File | Status |
|------|--------|
| `client/src/components/AICoach.tsx` | Modified |
...
#### Medium Priority
- [ ] `docs/architecture/client-structure.md` - Component changes (client/src/components/AICoach.tsx)
- [ ] `docs/architecture/api-reference.md` - Briefing API changes (server/api/briefing/briefing.js)
- [ ] `docs/preflight/location.md` - Venue logic changes (server/lib/venue/venue-address-resolver.js)
