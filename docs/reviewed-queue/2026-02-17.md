...
| `client/src/components/AICoach.tsx` | Renamed |
| `client/src/pages/co-pilot/StrategyPage.tsx` | Modified |
| `docs/ai-tools/agent.md` | Modified |
| `docs/architecture/ai-pipeline.md` | Modified |
| `docs/architecture/api-reference.md` | Modified |
...
**Generated:** 2026-02-17T16:42:53.122Z
**Branch:** main
**Last Commit:** a29b3766 Published your App

### Uncommitted Changes (3)
| File | Status |
|------|--------|
| `erver/db/db-client.js` | Modified |
| `server/lib/ai/adapters/index.js` | Modified |
| `server/lib/ai/model-registry.js` | Modified |

### Recent Commit Changes (87)
| File | Status |
|------|--------|
| `.claude/settings.local.json` | Modified |
| `.env.example` | Modified |
...
| `client/src/hooks/useMemory.ts` | Modified |
| `client/src/pages/co-pilot/StrategyPage.tsx` | Modified |
| `docs/BRIEFING_AND_EVENTS_ISSUES.md` | Added |
| `docs/DATABASE_SCHEMA.md` | Modified |
| `docs/VENUELOGIC.md` | Modified |
| `docs/ai-tools/agent.md` | Modified |
| `docs/architecture/ai-pipeline.md` | Modified |
...
#### Low Priority
- [ ] Consider adding documentation - New file added (server/lib/events/pipeline/geocodeEvent.js)
- [ ] Consider adding documentation - New file added (server/scripts/backfill-timezone.js)
- [ ] Consider adding documentation - New file added (server/scripts/consolidate-markets.js)
...
**Generated:** 2026-02-17T17:13:22.713Z
**Branch:** main
**Last Commit:** 7b68dfb1 fix(docs): Remove AI preamble from client-structure.md

### Uncommitted Changes (4)
| File | Status |
|------|--------|
| `ocs/architecture/server-structure.md` | Modified |
| `docs/review-queue/2026-02-17.md` | Modified |
| `docs/review-queue/pending.md` | Modified |
| `sent-to-strategist.txt` | Modified |
