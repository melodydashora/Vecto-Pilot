...
#### Google Routes API
- **Files**: `server/lib/routes/routes-api.js`
- **Endpoints**: 
...
- **Files**: `client/src/hooks/useGeoPosition.tsx`
...
#### Anthropic (Claude)
- **Files**: 
  - `server/lib/adapters/anthropic.js`
  - `server/routes/chat.js`
  - `server/eidolon/core/llm.ts`
...
#### OpenAI (GPT-5)
- **Files**: 
  - `server/lib/adapters/openai.js`
  - `server/lib/planning/gpt5-tactical-planner.js`
  - `server/lib/venues/gpt5-venue-generator.js`
...
#### Google Gemini
- **Files**: 
  - `server/lib/adapters/gemini.js`
  - `server/lib/enrichment/gemini-news-briefing.js`
  - `server/lib/enrichment/gemini-enricher.js`
...
#### Perplexity API
- **Files**: 
  - `server/lib/adapters/perplexity.js`
  - `server/lib/enrichment/perplexity-research.js`
  - `server/lib/venues/venue-event-research.js`
...
- **Files**: `server/lib/integrations/faa-asws.js`
- **Endpoints**: 
...
### Direct SQL Queries
- **Files**: 
  - `server/lib/coach/coach-dal.js` - Coach data access
  - `server/lib/providers/briefing.js` - Briefing queries
  - `server/routes/actions.js` - Metrics updates
  - `scripts/database/postdeploy-sql.mjs` - Migration runner
...
### Multi-Model Router
- **Files**: 
  - `server/lib/llm/llm-router.js`
  - `server/lib/llm/llm-router-v2.js`
- **Features**:
