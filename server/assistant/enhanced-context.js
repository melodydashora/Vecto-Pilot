...
const MEMORY_TABLE = "assistant_memory";
const SYSTEM_PROMPT = "You are Assistant, a helpful AI with deep technical knowledge. Provide accurate, up-to-date information with citations from web search results.";
