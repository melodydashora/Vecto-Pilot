...
export async function generateTacticalPlan({ strategy, snapshot }) {
  ...
  const developer = [
    ...
    "- DO NOT recommend multiple venues in the same building/complex (e.g., don't list 5 venues all at 'The Star')",
    "- Spread recommendations to cover strategic area while still being reachable from one staging point",
    "- Example: Instead of 'Ford Center at The Star' + 'Omni at The Star' + 'Cowboys Fit at The Star', choose ONE venue from The Star and find others 2-3 min away",
    "",
